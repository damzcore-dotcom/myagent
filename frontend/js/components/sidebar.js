...
const ICONS = {
  ...
  bot: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9" stroke-dasharray="3 3" opacity="0.4"/><circle cx="12" cy="12" r="6" opacity="0.7"/><circle cx="12" cy="12" r="3" fill="currentColor"/><path d="M12 3v18M16 6v12M8 6v12M20 10v4M4 10v4" opacity="0.85"/></svg>`,
